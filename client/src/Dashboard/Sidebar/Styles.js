...
export const CalLabInfo = styled.div`
  display: flex;
  padding: 24px 4px;
`;

export const CalLabTexts = styled.div`
  padding: 3px 0 0 10px;
`;

export const CalLabName = styled.div`
  color: ${color.textDark};
  ${font.size(15)};
  ${font.medium};
`;

export const CalLabCategory = styled.div`
...
export const ChildLinkItem = styled.div`
  margin-left: 20px;
  position: relative;
  display: flex;
  padding: 8px 12px;
